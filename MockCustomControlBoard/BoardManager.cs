...
namespace IctCustomControlBoard
{
    public class BoardManager
    {
        ...
        public void SetBits(ulong bits)
        {
            ...
            // *** below is simulating a readback ***

            // Board 1 maps to Board 3
            board3.SetBits("port0", b1_port0);
            board3.SetBits("port1", b1_port1);
            board3.SetBits("port2", b1_port2);

            // Board 2 maps to Board 4
            board4.SetBits("port0", b2_port0);
            board4.SetBits("port1", b2_port1);
            board4.SetBits("port2", b2_port2);
        }
